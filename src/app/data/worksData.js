const worksData = [
  ...
  // faveTag
  {
    ...
    // 作品概要(作品の説明、課題、解決策)
    workSummary:
      "世の中を便利にするWebという授業テーマで、私は洋楽好きに向けたコミュニティWebアプリを制作しました。",
    // 工夫点
    point: "",
    // 反省点
    reflection:
      "時間配分が難しく、fave#の制作期間が短くなり納得の行くクオリティのものが作れていないことです。時間配分が難しいと感じた原因は、1年の後期で初めて個人制作とチーム制作の掛け持ちをし、新しい技術を学ぶ事が多い。そのため、機能の洗い出しやデザインが不十分なまま、コーディングに入ってしまいました。その結果、",
    // 振り返り
    review: "",
  },
  // ゆるめ旅
