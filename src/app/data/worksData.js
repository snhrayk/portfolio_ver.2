const worksData = [
  // herstel(完了)
  {
    ...
    // 振り返り
    review:
      "今見ると、改善点ばかりが目立ちますが、改善点が多いと感じるのは自分が成長した証拠だと思っています。herstelは授業で学んだhtmlやcssを初めてアウトプットした作品で、コーディングの楽しさを知るきっかけになりました。",
  },
  ...
  // キャンドルナイトポスター(完了)
  {
    ...
    // 作品概要(作品の説明、課題、解決策)
    workSummary:
      "大阪市北区中崎町で毎年開催されるキャンドルナイト。第13回のポスターを制作し、嬉しいことに準グランプリをいただきました。",
    // 工夫点
    point:
      "キャンドルの暖かさだけではなくキャンドルがつなぐ人々の暖かさも伝わるように、人から人へキャンドルを渡している写真を使用しました。ポスター下半分にはグラデーションを使用しており、写真に負けること無く文字が読める様になっています。",
    // 反省点
    reflection:
      "キャンドルナイトに訪れる方の立場になって内容の優先順位を考えたとき、クレジット部分は一番優先順位が低いと感じ文字を小さくしてメリハリを付けました。ですが今画像で見た時に何が書かれているのかわからないくらい文字が小さいため、もう少し文字を大きくするべきだったと思いました。",
    // 振り返り
    review:
  ...
  // ポートフォリオ ver.1(完了)
  {
    ...
    // 作品概要(作品の説明、課題、解決策)
    workSummary:
      "レトロなパソコン画面風のデザイン。私が好きなy2kデザイン、海外ぽさを感じるポップなカラーを使用することで、個性を表現しています。",
    // 工夫点
    point:
  ...
  // 歴てく(一旦完了)
  {
    ...
    // 作品概要(作品の説明、課題、解決策)
    workSummary:
      "クライアントの方からの依頼で、福岡県の歴史スポットを回るツアーを提案するサイトを制作しました(授業課題)。紹介する歴史スポットの中にはマイナーな場所もあり整備が行き届いていない場合があると考え、私のチームは体力面に配慮しながらもツアーを楽しめるものとなっています。",
    // 工夫点
    point:
    ...
    // 振り返り
    review:
      "私のチームのWebサイトは残念ながら選ばれませんでしたが、私が作成したロゴやgoogle my mapの仕様書はクライアントの方に採用して頂いたため大変嬉しかったです。",
  },
  // Dental Guide(完了)
  {
    id: 9,
  ...
  // Ride Clock(完了)
  {
    ...
    // 反省点
    reflection:
      "チームメンバーがより開発しやすいデザインになるように、開発に使用したSwiftUiの知識を少しでもつけておいた方が良かったと感じました。",
    // 振り返り
    review:
  ...
  // ポートフォリオ ver.2
  {
    id: 14,
    title: "ポートフォリオ ver.2",
    catchCopy: "コードも内容もパワーアップしたポートフォリオサイト",
    date: "2年後期",
    ...
    // 画像
    slideImg: [
      "/img/portfolioVer2_heading.webp",
      "/img/portfolioVer2_works_change.webp",
      "/img/portfolioVer2_works_add.webp",
      "/img/portfolioVer2_works_detail.webp",
      "/img/portfolioVer2_works_styles.webp",
      "/img/portfolioVer2_works_lightHouse.webp",
    ],
    // URL
    type: "webサイト",
    ...
    // 作品概要(作品の説明、課題、解決策)
    workSummary:
      "デザインは大きく変えず、コードを一から書き直しました。内容も充実させ、より私を知ってもらえるようなポートフォリオサイトにしました。",
    // 工夫点
    point:
      "デザインにもコードにもこだわり、より使いやすいサイトとなっています。詳しくは左のスライドに載せています。",
    // 反省点
    reflection:
      "レトロなパソコンというデザインのテーマは変更していなくても、情報量はver.1よりも増えたため中身のデザインが変わりました。そのため、思っていたよりも完成させるまでに時間がかかってしまいました。レスポンシブには非対応のため、今後の課題です。",
    // 振り返り
    review:
      "時間がかかってもデザインやコードにこだわって満足のいくサイトを作成できたため、LightHouseで高いスコアを獲得できたとき大変嬉しかったです。",
  },
  // Juice Timer(完了)
  {
    id: 15,
