          ...
          <section className={styles.about}>
            ...
            <div className={styles.detailWrap}>
              ...
              <div className={styles.detailChild}>
                ...
                <div className={styles.alwaysWrap}>
                  <h4>コーディング中意識していること</h4>
                  <p>
                    機能を実装する際、コーディングを行う前に、まずその機能に必要な動きは何かを一から最後まで考えて書き出してから、コーディングに移っています。
                    そうすることで複雑な機能も実装しやすくなり、無駄なコーディング時間を減らすことができました。
                    <br />
                    また、普段他の人が見てもわかりやすいコードを書くことを心がけています。
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      多くの資格を取得する。
                      <br />
                      高校2年の終わり頃、私は進路に迷っていた。そんな時に何十もの大学や専門学校が集まる進路説明会に参加した。どこに行こうか学校一覧のカタログで探していた時に、webデザイナーと言う職種が目に留まった。パソコンも絵を書くことが好きな私には合っているかもと興味を持ち、Webデザインを目指す。
                    </td>
                  </tr>
                  {/* <tr>
                    <th>専門学校(現在)</th>
